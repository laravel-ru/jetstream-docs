...
После включения функции фото профиля Вы должны выполнить Artisan-команду `storage:link`. Эта команда создаст символическую ссылку в общедоступном каталоге Вашего приложения `public` , которая позволит Вашему приложению обслуживать изображения Ваших пользователей. Для получения информации об этой команде обратитесь к [документации по файловой системе Laravel](https://laravel.com/docs/filesystem#the-public-disk):
